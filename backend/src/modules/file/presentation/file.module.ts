...
import { TypeOrmFileRepository } from '../infrastructure/persistence/typeorm/repositories/files.repository.impl';
import { FileOrm } from '../infrastructure/persistence/typeorm/entities/file-orm.entity';
