...
import { RenameDialog } from '../../../shared/components/dialogs/RenameDialog';
import { ConfirmDeleteDialog } from '../../../shared/components/dialogs/ConfirmDeleteDialog';
import { ShareDialog } from '../../../shared/components/dialogs/ShareDialog';
...
export const FolderCard = ({ folder, onNavigate }: FolderCardProps) => {
